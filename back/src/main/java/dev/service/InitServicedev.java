...
public class InitServicedev implements InitService {
	...
	public void Init() {
		...
		Reservation reservation3 = new Reservation(Reservation.STATUT.TERMINE, profilrep.getOne(3), annonce1);
		...
		Coordonees coordonnees2 = new Coordonees(dateCoordonnees1, "104.53543,-502.45684");
		Coordonees coordonnees3 = new Coordonees(dateCoordonnees1, "120.53543,-540.45684");
		Coordonees coordonnees4 = new Coordonees(dateCoordonnees1, "140.53543,-540.45684");
		Coordonees coordonnees5 = new Coordonees(dateCoordonnees1, "100.53543,-50.45684");
